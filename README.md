...
For Plots `v2` [WIP](https://github.com/JuliaPlots/Plots.jl/pull/4904), the reference images are included in the [assets](https://github.com/JuliaPlots/Plots.jl/tree/v2/assets) directory of the monorepo.
